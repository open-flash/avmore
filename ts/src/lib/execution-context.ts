...
import { Target } from "./host";
import { RegisterTable } from "./register-table";
import { BaseRuntime, ToPrimitiveHint } from "./runtime";
...
import { Activation, ScriptActivation, TargetId, Vm } from "./vm";
 ...
 */
export class MissingPropertyDetector {
